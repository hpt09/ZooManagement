...
Variables are declared here in the protected so all subclasses can use it. This enables us to
to inherit the variables and functions so they don't need to be defined in all subclasses which is good OOP.
*/
class Animal {
protected:
